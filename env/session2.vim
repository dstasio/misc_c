...
silent! normal! zE
let s:l = 21 - ((14 * winheight(0) + 26) / 53)
...
wincmd w
argglobal
if bufexists("code\main.cpp") | buffer code\main.cpp | else | edit code\main.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 2resize ' . ((&columns * 118 + 118) / 236)
tabnext 1
badd +84 code\dst\dst_file.h
badd +38 code\dst\dst_0_memory.h
badd +10 code\build.bat
badd +6 code\main.cpp
badd +1 code\main.h
badd +19 code\unzip.h
badd +1 code\UniNo.cpp
badd +41 code\dst\dst_unicode.h
badd +5 code\dst\todo.txt
